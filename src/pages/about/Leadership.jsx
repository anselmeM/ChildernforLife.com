...
export default function Leadership() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <PageSEO title="Leadership" description="The leadership team driving Children for Life's mission forward." path="/about/leadership" />
      <div className="relative h-[260px] sm:h-[320px] lg:h-[380px] bg-cover bg-center bg-local md:bg-fixed flex items-center" style={{ backgroundImage: `url(${monthlyGiving})` }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-white">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight mb-3 drop-shadow-md">Our Leadership</h1>
