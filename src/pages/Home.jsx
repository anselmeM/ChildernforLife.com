...
// WebP variants (generated by scripts/optimize-images.py)
import heroStudentsFull from '../assets/hero_students.full.webp';
import sallyStoryFull from '../assets/sally_story.full.webp';
import ugirlsGraduationCard from '../assets/ugirls_graduation.card.webp';
import monthlyGivingCard from '../assets/monthly_giving.card.webp';
...
export default function Home() {
  ...
  return (
    <div ref={pageRef} className="flex flex-col min-h-screen">
      <Helmet>
        {/* Preload the above-the-fold hero image (LCP) */}
        <link rel="preload" as="image" href={heroStudentsFull} />
      </Helmet>
      <PageSEO
        schema={{
          '@type': 'WebSite',
      ...
      <section className="relative w-full h-[400px] sm:h-[500px] lg:h-[600px] flex items-center">
        <div 
          ...
          style={{ backgroundImage: `url(${heroStudentsFull})` }}
        >
      ...
      <section 
        ...
        style={{ backgroundImage: `url(${sallyStoryFull})` }}
      >
