        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <form onSubmit={(e) => { e.preventDefault(); navigate('/donate'); }} className="space-y-6 bg-gray-50 border border-gray-150 p-8 rounded-3xl">
            <div>
              ...
              <input id="tribute-honoree" required type="text" placeholder="Honoree Name" className="w-full border border-gray-300 rounded-lg px-4 py-3 font-semibold focus:outline-none focus:border-[#005c7a]" />
            </div>
            <div>
              ...
              <input id="tribute-recipient-name" required type="text" placeholder="Recipient Name" className="w-full border border-gray-300 rounded-lg px-4 py-3 font-semibold focus:outline-none focus:border-[#005c7a] mb-3" />
              <input id="tribute-recipient-email" required type="email" placeholder="Recipient Email" aria-label="Recipient Email" className="w-full border border-gray-300 rounded-lg px-4 py-3 font-semibold focus:outline-none focus:border-[#005c7a]" />
            </div>
