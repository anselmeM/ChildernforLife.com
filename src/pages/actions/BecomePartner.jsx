...
export default function BecomePartner() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <PageSEO title="Become a Partner" description="Partner with Children for Life to deliver specialized community programs." path="/partner" />
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert("Partnership Inquiry Received!"); navigate('/'); }} className="space-y-4 bg-gray-50 border border-gray-150 p-8 rounded-3xl">
              ...
              <div>
                <label htmlFor="partner-contact" className="block text-xs font-bold text-gray-500 uppercase mb-1">Contact Name</label>
                <input id="partner-contact" required type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2 font-semibold focus:outline-none focus:border-[#005c7a]" />
              </div>
              <div>
                <label htmlFor="partner-email" className="block text-xs font-bold text-gray-500 uppercase mb-1">Contact Email</label>
                <input id="partner-email" required type="email" className="w-full border border-gray-300 rounded-lg px-4 py-2 font-semibold focus:outline-none focus:border-[#005c7a]" />
              </div>
